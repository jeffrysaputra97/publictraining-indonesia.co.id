<?php
    ...
    // function register_user($username, $password, $fullname, $email, $phone, $address, $gender, $birthplace,
    //                        $birthdate, $education, $major, $institute, $position, $instance, $year){
    //     global $conn;
    //
    //     $realPassword = $password;
    //     $password = password_hash($password, PASSWORD_DEFAULT);
    //     //prepare and bind
    //     $stmt = $conn->prepare("insert into users(username, password, fullname, email, phone, address, gender, birthplace,
    //                             birthdate, education, major, institute, position, instance, year) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    //     $stmt->bind_param("sssssssssssssss", $username, $password, $fullname, $email, $phone, $address, $gender, $birthplace,
    //                       $birthdate, $education, $major, $institute, $position, $instance, $year);
    //     $stmt->execute();
    //
        ...
        // $headers[] = 'To: '. $email .'';
        // $headers[] = 'Cc: jeffrysaputra97@gmail.com';
        // $message = '
        // <html>
        //     <body>
