...
<html lang="en">
  <head>
    ...
    <title>Pendaftaran Regular Program</title>
    <!-- Bootstrap -->
			...
			<div class="col-md-9 col-lg-10">
				<div class="content-set">
					<div class="recolor content-header">
						<div class="header">Pendaftaran Regular Program (E-Learning)</div>
					</div>
					<div class="content-form">
						Pilih program untuk memulai
					</div>
					<br>
                    <form action="pendaftaran_regular_program_1.php" method="post">
                        <div class="form-group">
                            <div class=" col-md-4">
                            ...
                            <div class=" col-md-4">
                                <button type="submit" class="btn btn-primary btn-potition" name="filter" value="filter">FILTER</button>
                            </div>
                        </div>
                    </form>
                    <form action="pendaftaran_regular_program_2.php" method="post">
                        <div class="form-group">
                            <div class="table-design">
                                ...
                                ?>
                                            <tr>
                                                <td> <input type="radio" name="optionsRadios" id="optionsRadios1" value="<?=$data['program_id']?>"> </td>
                                                <td><?=$data['batch']?></td>
                            ...
                            <div class=" col-md-4">
                                <button type="submit" class="btn btn-primary btn-potition" name="submit" value="pilih">PILIH </button>
                            </div>
                        </div>
                    </form>
				</div>
